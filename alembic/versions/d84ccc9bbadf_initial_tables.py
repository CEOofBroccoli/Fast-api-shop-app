...
def upgrade() -> None:
    ...
    op.execute("CREATE TYPE IF NOT EXISTS invoicestatus AS ENUM ('Draft', 'Sent', 'Received', 'Closed')")
    op.execute("CREATE TYPE IF NOT EXISTS salesorderstatus AS ENUM ('Pending', 'Confirmed', 'Shipped', 'Delivered', 'Cancelled')")
    ...
    sa.Column('status', postgresql.ENUM('Draft', 'Sent', 'Received', 'Closed', name='invoicestatus'), nullable=True),
