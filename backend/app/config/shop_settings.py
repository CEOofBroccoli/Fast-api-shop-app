...
class ShopSettings:
    ...
    def __init__(self):
        ...
        self.shop_description = os.getenv(
        ...
        self.company_logo_url = os.getenv(
            "COMPANY_LOGO_URL", "/static/images/logos/n-market-logo.png"
        )
        self.company_logo_square_url = os.getenv(
        ...
        self.company_favicon_url = os.getenv(
            "COMPANY_FAVICON_URL", "/static/images/logos/icon3.ico"
        )

        # Additional logo variants
        self.company_logo_hd_url = os.getenv(
            "COMPANY_LOGO_HD_URL", "/static/images/logos/hd-logo.png"
        )
        self.company_logo_small_url = os.getenv(
            "COMPANY_LOGO_SMALL_URL", "/static/images/logos/small.png"
        )

        # Email Configuration
        self.email_from = os.getenv(
            "EMAIL_FROM", f'"{self.shop_name}" <{self.shop_email}>'
        )
